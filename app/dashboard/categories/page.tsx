...
<section className="bg-white  py-24 px-4 lg:px-16"> 
    <div className="container mx-auto px-[12px] md:px-24 xl:px-12 max-w-[1300px] nanum2">
        <h1 className="text-center text-5xl pb-12">Categorias actuales</h1>
                    ...
                    <div className="h-28">
                        <div
                            ...
                            <img src="https://epicpadprinting.com/public/img/indus/Electric.png"
                                className="w-36 h-36  mt-6 m-auto" alt="Electric" title="Electric" loading="lazy"
                                width="200" height="200"/>
                        </div>
                    </div>
                    <div className="p-6   z-10 w-full   ">
                    ...
                    <div className="h-28">
                        <div
                            ...
                            <img src="https://epicpadprinting.com/public/img/indus/Caps-and-Closures.png"
                                className="w-36 h-36  mt-6 m-auto" alt="Caps and Closures" title="Caps and Closures"
                                loading="lazy" width="200" height="200"/>
                        </div>
                    </div>
                    <div className="p-6   z-10 w-full   ">
                    ...
                    <div className="h-28">
                        <div
                            ...
                            <img src="https://epicpadprinting.com/public/img/indus/Utensils.png"
                                className="w-36 h-36  mt-6 m-auto" alt="Utensils" title="Utensils" loading="lazy"
                                width="200" height="200"/>
                        </div>
                    </div>
                    <div className="p-6   z-10 w-full   ">
